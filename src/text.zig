...
pub fn mesh_from_rect(x: f32, y: f32, w: f32, h: f32, color: u32) [2]storage.Triangle {
    const tri_top_left = storage.Triangle{ .p0 = V3{ .x = x, .y = y, .z = 0 }, .p1 = V3{ .x = x + w, .y = y, .z = 0 }, .p2 = V3{ .x = x + w, .y = y + h, .z = 0 }, .color = color };
    const tri_bottom_right = storage.Triangle{ .p0 = V3{ .x = x + w, .y = y + h, .z = 0 }, .p1 = V3{ .x = x, .y = y + h, .z = 0 }, .p2 = V3{ .x = x, .y = y, .z = 0 }, .color = color };
